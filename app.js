...
const API_KEY = 'e778bcfe917296e2c3826c10324f66ce';
...
function getWeatherData () {
    navigator.geolocation.getCurrentPosition((success) => {
        ...
        let {latitude, longitutde } = success.coords;

        fetch(`https://api.openweathermap.org/data/3.0/onecall?lat=${latitude}&lon=${longitutde}&exclude=hourly,minutely&units=metric&appid=${API_KEY}`).then(res => res.json()).then(data => {
